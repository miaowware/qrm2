...
us_calls = OrderedDict([('**Group A** (Extra Only)', ('**Any:** K, N, W (1x2)\n'
                        ...
                        ('**Group D** (Any License Class)', ('**Any Region:** KA-KZ, WA-WZ (2x3)\n'
                                                             ...
                                                             '**Caribbean:** KP, WP (2x3)\n'
                                                             '**Pacific:** KH, WH (2x3)')),
                        ('**Unavailable**', ('- KA2AA-KA9ZZ: reserved for US Army-authorized amateur stations in Japan.\n'
                                             ...
                                             '- Due to the United States\' former administration of the Trust Territory of the Pacific Islands, '
                                             'hams in the TTPI were issued US call signs.\n'
                                             '- KC6AA-KC6ZZ -- KC6 was two DXCC entities: The Eastern Caroline Islands and the Western Caroline '
                                             'Islands. The Eastern Carolines became the Federated States of Micronesia (V6) and the Western Carolines '
